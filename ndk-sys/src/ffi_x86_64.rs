...
pub const ADisplayLuts_Dimension_ADISPLAYLUTS_ONE_DIMENSION: ADisplayLuts_Dimension = 1;
pub const ADisplayLuts_Dimension_ADISPLAYLUTS_THREE_DIMENSION: ADisplayLuts_Dimension = 3;
pub type ADisplayLuts_Dimension = i32;
pub const ADisplayLuts_SamplingKey_ADISPLAYLUTS_SAMPLINGKEY_RGB: ADisplayLuts_SamplingKey = 0;
pub const ADisplayLuts_SamplingKey_ADISPLAYLUTS_SAMPLINGKEY_MAX_RGB: ADisplayLuts_SamplingKey = 1;
pub const ADisplayLuts_SamplingKey_ADISPLAYLUTS_SAMPLINGKEY_CIE_Y: ADisplayLuts_SamplingKey = 2;
pub type ADisplayLuts_SamplingKey = i32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ADisplayLutsEntry {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ADisplayLuts {
    _unused: [u8; 0],
}
extern "C" {
    pub fn ADisplayLutsEntry_createEntry(
        buffer: *mut f32,
        length: i32,
        dimension: ADisplayLuts_Dimension,
        key: ADisplayLuts_SamplingKey,
    ) -> *mut ADisplayLutsEntry;
}
extern "C" {
    pub fn ADisplayLutsEntry_destroy(entry: *mut ADisplayLutsEntry);
}
extern "C" {
    pub fn ADisplayLutsEntry_getDimension(
        entry: *const ADisplayLutsEntry,
    ) -> ADisplayLuts_Dimension;
}
extern "C" {
    pub fn ADisplayLutsEntry_getSize(entry: *const ADisplayLutsEntry) -> i32;
}
extern "C" {
    pub fn ADisplayLutsEntry_getSamplingKey(
        entry: *const ADisplayLutsEntry,
    ) -> ADisplayLuts_SamplingKey;
}
extern "C" {
    pub fn ADisplayLutsEntry_getBuffer(entry: *const ADisplayLutsEntry) -> *const f32;
}
extern "C" {
    pub fn ADisplayLuts_create() -> *mut ADisplayLuts;
}
extern "C" {
    pub fn ADisplayLuts_setEntries(
        luts: *mut ADisplayLuts,
        entries: *mut *mut ADisplayLutsEntry,
        numEntries: i32,
    );
}
extern "C" {
    pub fn ADisplayLuts_destroy(luts: *mut ADisplayLuts);
}
...
pub const REG_R8: _bindgen_ty_32 = 0;
pub const REG_R9: _bindgen_ty_32 = 1;
pub const REG_R10: _bindgen_ty_32 = 2;
pub const REG_R11: _bindgen_ty_32 = 3;
pub const REG_R12: _bindgen_ty_32 = 4;
pub const REG_R13: _bindgen_ty_32 = 5;
pub const REG_R14: _bindgen_ty_32 = 6;
pub const REG_R15: _bindgen_ty_32 = 7;
pub const REG_RDI: _bindgen_ty_32 = 8;
pub const REG_RSI: _bindgen_ty_32 = 9;
pub const REG_RBP: _bindgen_ty_32 = 10;
pub const REG_RBX: _bindgen_ty_32 = 11;
pub const REG_RDX: _bindgen_ty_32 = 12;
pub const REG_RAX: _bindgen_ty_32 = 13;
pub const REG_RCX: _bindgen_ty_32 = 14;
pub const REG_RSP: _bindgen_ty_32 = 15;
pub const REG_RIP: _bindgen_ty_32 = 16;
pub const REG_EFL: _bindgen_ty_32 = 17;
pub const REG_CSGSFS: _bindgen_ty_32 = 18;
pub const REG_ERR: _bindgen_ty_32 = 19;
pub const REG_TRAPNO: _bindgen_ty_32 = 20;
pub const REG_OLDMASK: _bindgen_ty_32 = 21;
pub const REG_CR2: _bindgen_ty_32 = 22;
pub const NGREG: _bindgen_ty_32 = 23;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct ACpuHeadroomParams {
    _unused: [u8; 0],
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct AGpuHeadroomParams {
    _unused: [u8; 0],
}
extern "C" {
    pub fn ACpuHeadroomParams_create() -> *mut ACpuHeadroomParams;
}
pub const ACpuHeadroomCalculationType_ACPU_HEADROOM_CALCULATION_TYPE_MIN:
    ACpuHeadroomCalculationType = 0;
pub const ACpuHeadroomCalculationType_ACPU_HEADROOM_CALCULATION_TYPE_AVERAGE:
    ACpuHeadroomCalculationType = 1;
pub type ACpuHeadroomCalculationType = ::std::os::raw::c_uint;
pub const AGpuHeadroomCalculationType_AGPU_HEADROOM_CALCULATION_TYPE_MIN:
    AGpuHeadroomCalculationType = 0;
pub const AGpuHeadroomCalculationType_AGPU_HEADROOM_CALCULATION_TYPE_AVERAGE:
    AGpuHeadroomCalculationType = 1;
pub type AGpuHeadroomCalculationType = ::std::os::raw::c_uint;
extern "C" {
    pub fn ACpuHeadroomParams_setCalculationWindowMillis(
        params: *mut ACpuHeadroomParams,
        windowMillis: ::std::os::raw::c_int,
    );
}
extern "C" {
    pub fn ACpuHeadroomParams_getCalculationWindowMillis(
        params: *mut ACpuHeadroomParams,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn AGpuHeadroomParams_setCalculationWindowMillis(
        params: *mut AGpuHeadroomParams,
        windowMillis: ::std::os::raw::c_int,
    );
}
extern "C" {
    pub fn AGpuHeadroomParams_getCalculationWindowMillis(
        params: *mut AGpuHeadroomParams,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ACpuHeadroomParams_setCalculationType(
        params: *mut ACpuHeadroomParams,
        calculationType: ACpuHeadroomCalculationType,
    );
}
extern "C" {
    pub fn ACpuHeadroomParams_getCalculationType(
        params: *mut ACpuHeadroomParams,
    ) -> ACpuHeadroomCalculationType;
}
extern "C" {
    pub fn AGpuHeadroomParams_setCalculationType(
        params: *mut AGpuHeadroomParams,
        calculationType: AGpuHeadroomCalculationType,
    );
}
extern "C" {
    pub fn AGpuHeadroomParams_getCalculationType(
        params: *mut AGpuHeadroomParams,
    ) -> AGpuHeadroomCalculationType;
}
extern "C" {
    pub fn ACpuHeadroomParams_setTids(
        params: *mut ACpuHeadroomParams,
        tids: *const ::std::os::raw::c_int,
        tidsSize: ::std::os::raw::c_int,
    );
}
extern "C" {
    pub fn AGpuHeadroomParams_create() -> *mut AGpuHeadroomParams;
}
extern "C" {
    pub fn ACpuHeadroomParams_destroy(params: *mut ACpuHeadroomParams);
}
extern "C" {
    pub fn AGpuHeadroomParams_destroy(params: *mut AGpuHeadroomParams);
}
extern "C" {
    pub fn ASystemHealth_getCpuHeadroom(
        params: *const ACpuHeadroomParams,
        outHeadroom: *mut f32,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ASystemHealth_getGpuHeadroom(
        params: *const AGpuHeadroomParams,
        outHeadroom: *mut f32,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ASystemHealth_getCpuHeadroomMinIntervalMillis(
        outMinIntervalMillis: *mut i64,
    ) -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn ASystemHealth_getGpuHeadroomMinIntervalMillis(
        outMinIntervalMillis: *mut i64,
    ) -> ::std::os::raw::c_int;
}
