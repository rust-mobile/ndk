...
pub struct user_fpregs_struct {
    ...
    pub ftw: ::core::ffi::c_ushort,
    pub fop: ::core::ffi::c_ushort,
    pub rip: ::core::ffi::c_ulong,
    pub rdp: ::core::ffi::c_ulong,
    pub mxcsr: ::core::ffi::c_uint,
    pub mxcr_mask: ::core::ffi::c_uint,
    pub st_space: [::core::ffi::c_uint; 32usize],
    pub xmm_space: [::core::ffi::c_uint; 64usize],
    pub padding: [::core::ffi::c_uint; 24usize],
}
#[test]
...
fn bindgen_test_layout_user_regs_struct() {
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).orig_rax) as usize - ptr as usize },
        120usize,
...
fn bindgen_test_layout_user() {
    ...
    let ptr = UNINIT.as_ptr();
    assert_eq!(::core::mem::size_of::<user>(), 928usize, "Size of user");
    assert_eq!(::core::mem::align_of::<user>(), 8usize, "Alignment of user");
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::core::ptr::addr_of!((*ptr).pad0) as usize - ptr as usize },
        220usize,
...
pub type greg_t = ::core::ffi::c_long;
...
pub struct _libc_fpxreg {
    ...
    pub padding: [::core::ffi::c_ushort; 3usize],
}
#[test]
...
pub struct mcontext_t {
    ...
    pub __reserved1: [::core::ffi::c_ulong; 8usize],
}
#[test]
