...
pub fn set(name: &CStr, value: &CStr) -> std::io::Result<()> {
    // TODO: Reset errno because the implementation sets it very inconsistently:
    // https://cs.android.com/android/platform/superproject/main/+/main:bionic/libc/bionic/system_property_set.cpp;l=283-286;drc=620eec1f3546523fab4f58fa6733e7faa34e4fd2
    // (or don't parse any errno, leaving valuable context by the wayside on most occasions)
