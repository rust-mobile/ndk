...
See these [`ndk-examples`](https://github.com/rust-mobile/cargo-apk/tree/main/ndk-examples/examples) and these [`rust-android-examples`](https://github.com/rust-mobile/rust-android-examples) for examples using the NDK.
